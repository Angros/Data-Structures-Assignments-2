...
public class NodeTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("This is the data of the first node: " + 
				list.getData());
		System.out.println("This is the data of the second node: " + 
				list.getNext().getData());
		System.out.println("This is the data of the third node: " + 
				list.getNext().getNext().getData());
		System.out.println("This is the data of the fourth node: " + 
